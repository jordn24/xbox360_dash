    ...
    return (
        <div className="row float-right mb-1">
            <div className="col-lg-2 offset-lg-9 col-7">
                <p className="text-white float-end mt-1 fs-3 d-lg-none d-xl-block">Jordan Sposito</p>
                <p className="text-white float-end mt-3 fs-5 d-none d-xl-none d-lg-block">Jordan Sposito</p>
            </div>
